...
| 5 | Subagent-spawn tool name | `Agent` | Verified against `~/.claude/skills/xan-edit-agents/SKILL.md` and the tool schema available in this Claude Code build; `subagent_type` is the parameter the Agent tool exposes. |
