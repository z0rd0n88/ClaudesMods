...
- **Before** — [`idea-panel`](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/idea-panel)
  to generate candidate directions, or
  [`idea-autopsy`](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/idea-autopsy)
  to pressure-test whether the idea is worth specifying at all.
- **After** — hand the finished spec to
  [`multi-agent-developer`](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/multi-agent-developer)
  or [`code-rinse-repeat`](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/code-rinse-repeat)
  to build it.
