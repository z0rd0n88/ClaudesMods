...
|---|---|---|
| Spec → code | `multi-agent-developer` | [sibling plugin in ClaudesMods](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/multi-agent-developer) |
| Code → findings / Findings → APPROVE on existing PR | **`multi-agent-review`** | this plugin |
| Spec → APPROVE end-to-end | `code-rinse-repeat` | [sibling plugin in ClaudesMods](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/code-rinse-repeat) |
| Pattern library for repo-wide review sweeps | [`total-review`](https://github.com/z0rd0n88/ClaudesMods/tree/main/ClaudesMods/total-review) | sibling plugin in ClaudesMods |
