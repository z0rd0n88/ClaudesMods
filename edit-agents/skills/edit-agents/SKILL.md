...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/edit-agents/edit-agents.sh" list
bash "${CLAUDE_PLUGIN_ROOT}/skills/edit-agents/edit-agents.sh" --scope user list
```
...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/edit-agents/edit-agents.sh" <command> [args]
```
